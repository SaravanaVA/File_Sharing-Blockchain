<?php
    ...
    if (@$_POST['publish']) {
    	//print 'testt';exit;
    		$encryptedData = get_encrypt_data($_POST['text'],$_POST['encryptKey']);
    		// print $encryptedData;
    
    		// print '<br><br>'.$decryptedData;
    	...
    	if (strlen($upload_file)) {
    		...
    		$data=string_to_txout_bin($encryptedData);
...
<div class="row">
    <div class="col-sm-12">
        ...
        <form class="form-horizontal" method="post" enctype="multipart/form-data"  action="./?chain=<?php echo html($_GET['chain'])?>&page=<?php echo html($_GET['page'])?>">
            ...
            <div class="form-group">
                <label for="key" class="col-sm-2 control-label"> Title key:</label>
                <div class="col-sm-9">
                    <input class="form-control" name="key" id="key" required>
                </div>
            </div>
            <div class="form-group">
                <label for="encryptKey" class="col-sm-2 control-label">Private Key:</label>
                <div class="col-sm-9">
                    <input class="form-control" name="encryptKey" maxlength="12" id="encryptKey" required>
                </div>
            </div>
            <div class="form-group">
        ...
        <div class="alert alert-info" style="background: grey; color: white;">
            <strong>Title Key:&nbsp;&nbsp;</strong> Use select your data: It may be any value for your Identification.
        </div>
        <div class="alert alert-info" style="background: grey; color: white;">
            <strong>Private Key:&nbsp;&nbsp;</strong> Have to <strong>remember this recover your data</strong>. Otherwise, you will not able to recover this. It may be any value with max length of 12.
        </div>
    </div>
</div>